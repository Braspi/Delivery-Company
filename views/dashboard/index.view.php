...
<body class="bg-[#e7e7e7]">
    <div class="w-[300px] bg-[#F9F9F9] h-screen border text-[#4b4b4b]">
        <ul class="text-2xl">
            <li class="transition ease-in-out delay-0 mb-3 h-10 pl-10 flex justify-start border-[#53c9ff40] hover:text-[#3a6c81] hover:border-l-[5px] hover:border-[#53c9ff70] active:border-l-[7px] active:border-[#53c9ff] active:text-black">
