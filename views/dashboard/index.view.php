...
<body class="bg-[#F9F9F9]">
    <div class="w-[300px] bg-[#dfdfdf] h-screen border text-[#535353]">
        <ul class="text-2xl">
            <li class="transition ease-in-out delay-0 mb-3 h-10 pl-10 flex justify-start border-[#53c9ff40] hover:text-black hover:border-l-[5px] hover:border-[#53c9ff70] active:border-l-[7px] active:border-[#53c9ff]">
